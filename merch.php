  ...
  <body>
    ...
    <div>
      <div class="gallery" id="gallery">
        <h2 style="text-align:center">Merch Gallery</h2>
          <div class="gallery__wrapper">
            <div class="gallery__card">
              <a href = "merch_slideshow.php"><img src= "merch-images/img_ (1).png" height = "425px" width = "300px"></a>

            </div>
            <div class="gallery__card img2">
              <a href = "merch_slideshow.php"><img src= "merch-images/img_ (2).png" height = "425px" width = "300px"></a>


            </div>
            <div class="gallery__card img3">
              <a href = "merch_slideshow.php"><img src= "merch-images/img_ (3).png" height = "425px" width = "300px"></a>


            </div>
            <div class="gallery__card img4">
              <a href = "merch_slideshow.php"><img src= "merch-images/img_ (4).png" height = "425px" width = "300px"></a>
            </div>

            <div class="gallery__card">
              <a href = "merch_slideshow.php"><img src= "merch-images/img_ (5).png" height = "425px" width = "300px"></a>
