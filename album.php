  ...
  <body>
    ...
    <div>
      <div class="gallery" id="gallery">
        <h2 style="text-align:center">Album Art Gallery</h2>
          <div class="gallery__wrapper">
            <div class="gallery__card">
              <a href = "album_slideshow.php"><img src= "album-images/img-1.png" height = "425px" width = "300px"></a>

            </div>
            <div class="gallery__card img2">
              <a href = "album_slideshow.php"><img src= "album-images/img-2.png" height = "425px" width = "300px"></a>


            </div>
            <div class="gallery__card img3">
              <a href = "album_slideshow.php"><img src= "album-images/img-3.png" height = "425px" width = "300px"></a>


            </div>
            <!--div class="gallery__card img4">
              <a href = "album_slideshow.php_slideshow.php"><img src= "album_slideshow.php-images/img (4).png" height = "425px" width = "300px"></a>
            </div>

            <div class="gallery__card">
              <a href = "album_slideshow.php_slideshow.php"><img src= "album_slideshow.php-images/img (5).png" height = "425px" width = "300px"></a>
